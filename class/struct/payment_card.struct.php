<?php
class payment_card extends struct
{
	protected $number;
	protected $type;
	...
	public function __construct($number, $type, $expire_month, $expire_year, $start_month, $start_year, $cvv2, $first_name, $last_name, $billing_country, $billing_address, $external_customer_id){
		$this->number = $number;
		$this->type = $type;
